...
import { TirageAuSortRepository } from '~/api/tirage-au-sort/infrastructure/repository/repository'
...
import { Resultat } from '~/api/tirage-au-sort/domain/models/resultat'
